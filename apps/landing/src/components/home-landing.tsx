    ...
    <div className="landing-v2 landing-light-page landing-home-v2">
      ...
      >
        <div className="mx-auto max-w-shell px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="problem-intelligence-visual relative isolate mt-10 aspect-[21/9] overflow-hidden rounded-bento border border-[color:var(--bento-border)]">
            <Image
      ...
      <section className="bg-[color:var(--bg-sunken)]" aria-labelledby="filter-heading">
        <div className="mx-auto grid max-w-shell items-center gap-8 px-4 py-14 sm:px-6 lg:grid-cols-12 lg:gap-10 lg:px-8 lg:py-20">
          <Reveal className="mx-auto flex max-w-xl flex-col items-center text-center lg:col-span-5 lg:mx-0 lg:max-w-none lg:items-start lg:text-left">
            ...
            <div className="mt-8 inline-flex items-center gap-2 rounded-control border border-white/10 bg-graphite-900 px-4 py-3 text-sm font-medium text-[color:var(--bento-ink)]">
              <MagnifyingGlass weight="bold" className="h-4 w-4 text-brand-400" aria-hidden />
