...
const pt: Dict = {
  ...
  trustItem2Body: 'Valide o fluxo no seu nicho antes de assinar o Starter.',
  ...
  diff1Body: 'Busca local por categoria e cidade, com cobertura também na Europa quando fizer sentido para o time.',
  ...
  faqStillBody: 'Entre na lista ou veja os preços do Starter. Quando o app abrir, você valida o fluxo no seu nicho.',
...
const en: Dict = {
  ...
  trustItem2Body: 'Validate the flow in your niche before subscribing to Starter.',
  ...
  diff1Body: 'Local search by category and city, with Europe coverage when it fits your team.',
  ...
  faqStillBody: 'Join the waitlist or see Starter pricing. When the app opens, validate the flow in your niche.',
