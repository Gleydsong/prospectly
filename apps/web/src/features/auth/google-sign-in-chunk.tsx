...
import type { GoogleSignInButtonProps } from './google-sign-in-button';
...
function GoogleSignInButtonInner(props: GoogleSignInButtonProps) {
  const { onSuccess, onError, acceptTerms, organizationName, locale, disabled } = props;
...
export function GoogleSignInChunk({
  clientId,
  ...props
